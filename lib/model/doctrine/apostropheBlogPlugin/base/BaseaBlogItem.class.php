 ...
 * @property string $disqus_thread_identifier
 ...
 * @method string              getDisqusThreadIdentifier()   Returns the current record's "disqus_thread_identifier" value
 ...
 * @method aBlogItem           setDisqusThreadIdentifier()   Sets the current record's "disqus_thread_identifier" value
...
abstract class BaseaBlogItem extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('disqus_thread_identifier', 'string', 100, array(
             'type' => 'string',
             'length' => 100,
             ));
